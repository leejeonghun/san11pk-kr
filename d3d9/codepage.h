...
#ifndef SAN11PK_KR_D3D9_CODEPAGE_H_
#define SAN11PK_KR_D3D9_CODEPAGE_H_
...
class codepage final {
 public:
  ...
  explicit codepage(const wchar_t* str)
      : unicode_(const_cast<wchar_t*>(str)), use_external_buf_(true) {}

  ~codepage() {
    if (unicode_ != src_buf_ && !use_external_buf_) delete[] unicode_;
...
#endif  // SAN11PK_KR_D3D9_CODEPAGE_H_
