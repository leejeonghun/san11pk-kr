...
#ifndef SAN11PK_KR_D3D9_IAT_HOOKER_H_
#define SAN11PK_KR_D3D9_IAT_HOOKER_H_
...
class iat_hooker final {
 public:
  ...
  inline std::invoke_result_t<T, ARGS...> call_origin(ARGS... args) {
...
#endif  // SAN11PK_KR_D3D9_IAT_HOOKER_H_
