...
#ifndef SAN11PK_KR_D3D9_DLL_LOADER_H_
#define SAN11PK_KR_D3D9_DLL_LOADER_H_
...
class dll_loader final {
 public:
  ...
  inline std::invoke_result_t<T, ARGS...> call(const char *api_name, ARGS ...args) const {
...
#endif  // SAN11PK_KR_D3D9_DLL_LOADER_H_
